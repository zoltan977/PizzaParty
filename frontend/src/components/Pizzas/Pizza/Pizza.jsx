...
const Pizza = ({putInCart, selectPizza, pizza, key2}) => {
    ...
    useEffect(() => {
        ...
        if (pizzaRef.current) {
            observer.observe(pizzaRef.current);
        }
    ...
    return (
        <div ref={pizzaRef} className="pizza" data-id={key2}>
            <img src={"/images/pizzas/" + pizza.image} alt="" />
            <div className="dashboard">
                <div>
                    <svg viewBox="0 0 576 512" onClick={
                        (e) => putInCart(pizzaRef.current, document.querySelector(".pizzas"))
                        }>
...
export default connect(null, {putInCart, selectPizza})(Pizza)