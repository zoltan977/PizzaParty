...
import './Topping.css';
import usePutInCart from './../../../hooks/usePutInCart';

export default function Pizza({topping, key2}) {

    const [style, setStyle] = useState({})
    const [toppingNode, setToppingNode] = useState(null)
    ...
    const putInCart = usePutInCart(toppingNode, document.querySelector(".Toppings"))
    ...
    return (
        <div ref={toppingRef} className="Topping" style={style} data-id={key2}>
            ...
            <div className="dashboard">
                <div>
                    <svg viewBox="0 0 576 512" onClick={putInCart}>
